...
const Player = () => {
  ...
  useEffect(() => {
    console.log("Enrolled Courses:", enrolledCourses); // Debugging
    console.log("Course ID:", id);
  
    if (enrolledCourses.length > 0) {
      getCourseData();
    }
  }, [enrolledCourses, id]); // Now it updates when `enrolledCourses` changes

  console.log("Course Data:", courseData); // Debugging line

  if (!courseData) return <p>Loading course data...</p>; // Handle null state properly
